...
//audible续播菜单
#define LISTMENU_AUDIBLE_RESUME      41
...
//ape设置菜单
#define  APESET_MENU                 44

//定时关机设置菜单
#define  SLEEP_TIMER_SETMENU         45

//列表中菜单项入口菜单
#define SHUFFLE_PLAY                 46

//所有歌曲
#define ALLSONG_PLAY                 47

//record voice播放入口菜单
#define VOICE_MENU_PLAYING           48

//record voice播放入口菜单
#define VOICE_MENU_LASTPLAY          49

//m3u列表嵌套收藏夹入口菜单
#define M3ULIST_MENU_FAVOR           50
//m3u列表option
#define OPTION_M3ULIST_NORMAL        51 //播放
#define OPTION_M3ULIST_MPLAYING      52 //播放 + 正在播放
#define OPTION_M3ULIST_MPAUSE        53 //播放 + 上一次播放
#define OPTION_M3ULIST_RPLAYING      54
#define OPTION_M3ULIST_RPAUSE        55
#define LISTMENU_ENTRY_NO_GENRE      56
//menulist path_id定义
...
extern app_result_e list_scene_apecue_sure(void *param);
...
extern app_result_e set_scene_spnormal_sure(void *param);

extern app_result_e set_scene_spslower_sure(void *param);

extern app_result_e set_scene_spfaster_sure(void *param);

//实时叶子菜单回调函数
extern void set_scene_spnormal_callback(void);

extern void set_scene_spslower_callback(void);

extern void set_scene_spfaster_callback(void);
