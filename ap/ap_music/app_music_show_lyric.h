 ...
 * \date     2011-9-25
 *******************************************************************************/
#ifndef __APP_MUSIC_SHOW_LYRIC_H__
#define __APP_MUSIC_SHOW_LYRIC_H__
...
#define LYRIC_LINE_COUNT_ONE_PAGE  5    //一页歌词最多允许几行显示
#define LYRIC_MAX_WIDTH_ONE_LINE   150  //一行允许显示最多像素点 
...
/* 读取一个时间标签歌词内容缓冲区 */
extern uint8 lrc_buf[LRC_BUF_LEN + 2] _LCDBUF_DATA_ATTR_;
...
/* 读取一个时间标签歌词内容缓冲区 */
extern uint8 lrc_buf_temp[LRC_BUF_LEN + 2] _LCDBUF_DATA_ATTR_;
...
extern void lyric_deal_string(uint8 land_id);


#endif //__APP_MUSIC_SHOW_LYRIC_H__
