...
int32 ap_vfs_mount;
comval_t g_comval;
uint32 cmu_memclken_bak;
uint32 cmu_memclksel_bak;
//*lib file's info
...
uint8 track_string_buf[ID3_TRACK_SIZE];//用来缓存track string
...
uint8 sort_cmp_len; //第一遍能比较的最大长度
...
uint16 ap_plist_sorting_level = 4000;//自适应排序档位 有4000档 8000档 16000档
...
sorting_map_level     sorting_map_level_4k;
sorting_map_level     sorting_map_level_8k;
sorting_map_level     sorting_map_level_16k;
sorting_map_level*    sorting_map_level_cur = NULL;
