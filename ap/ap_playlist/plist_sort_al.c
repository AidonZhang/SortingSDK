...
static uint8 cmp_string1[CMPSTR_MAX_BUF] _BANK_DATA_ATTR_;
static uint8 cmp_string2[CMPSTR_MAX_BUF] _BANK_DATA_ATTR_;

//排序使用缓存
static char *lostk[50] _BANK_DATA_ATTR_;
static char *histk[50] _BANK_DATA_ATTR_;
