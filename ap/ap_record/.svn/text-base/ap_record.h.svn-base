...
//#define     FILE_NUM_MAX          200       //录音文件最大个数//2015-11-12
...
#define up_recordTxt            0x00000100    //录音标示显示 
...
#define clr_recordTxt           0xfffffeff    //清除录音标示显示
...
//REC_FORMAT_INVALID = 2,
    /* 录音格式: pcmwav */
    REC_FORMAT_PCM_WAV = 3,
    /* 录音格式: adpcm */
    REC_FORMAT_ADPCM_WAV = 4,
} record_file_type_e;
...
typedef struct
{
    ...
    record_bitrate_e pcm_wav_bitrate;
    record_bitrate_e adpcm_wav_bitrate;
    ...
    /* 录音监听功能: 0 关闭 ; 1 打开*/
    uint8 listening_flag;
    /* 监听 音量*/
    uint8 listening_volume;
...
extern uint8 g_sound_state_bak;
...
extern void clear_RTCACCESS(void)__FAR__; //2016-06-29
...
/*录音写回调函数*/
extern int32 mmm_mr_write(void *buf, int32 size, int32 count, storage_io_t *io) __FAR__;
