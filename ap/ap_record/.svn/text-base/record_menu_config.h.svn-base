...
#define ENTRY_BITRATE_PCM_WAV       6
#define ENTRY_BITRATE_ADPCM_WAV       7
#define ENTRY_ACT_CARD          8
#define ENTRY_ACT_NOCARD        9
...
extern app_result_e set_rec_format_pcmwav(void* param);
extern app_result_e set_rec_format_adpcmwav(void* param);
