...
const conf_menu_entry_t entry_rec[MENU_ENTRY_SIZE] =
{
    ...
    { ENTRY_BITRATE_PCM_WAV, SET_REC_BITRATE, SET_REC_FORMAT_WAV_PCM },
    { ENTRY_BITRATE_ADPCM_WAV, SET_REC_BITRATE, SET_REC_FORMAT_WAV_ADPCM },
...
const conf_menu_item_t item_rec[MENU_ITEM_SIZE] =
{
    ...
    { SET_REC_FORMAT_WAV, 0, set_rec_format_pcmwav, NULL, NULL, RAIDO_MENU_ITEM, 7, 0 },
   ...
   // { S_REC_STOP_NOISE_CANCELLATION, 0, set_noise_cancel_disable , NULL, NULL, RAIDO_MENU_ITEM, 31, 0 },
    ...
    { SET_REC_FORMAT_WAV_PCM, 0, set_rec_format_pcmwav, NULL, NULL, RAIDO_MENU_ITEM, 34, 0 },
    { SET_REC_FORMAT_WAV_ADPCM, 0, set_rec_format_adpcmwav, NULL, NULL, RAIDO_MENU_ITEM, 35, 0 }
