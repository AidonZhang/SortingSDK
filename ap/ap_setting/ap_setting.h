...
#define MENU_ENTRY_ID_SHUT_DOWN_ON      0x01
#define MENU_ENTRY_ID_SHUT_DOWN_OFF        0x02
#define MENU_ENTRY_ID_INFOR_WITH_SN        0x03
#define MENU_ENTRY_ID_INFOR_WITHOUT_SN    0x04
...
extern uint8 SN_buffer[SN_SIZE];   //存放SN数据
