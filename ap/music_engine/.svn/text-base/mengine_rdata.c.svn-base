...
//标识audbile文件
uint8 g_is_audible = 0;

//audible断点续播标志
uint8 g_is_audible_resume = 0;
...
//audbile info ptr
audible_para_t *g_audible_info_p = (audible_para_t *) 0x9fc23000;//use the wma lossless EQ buf
//sent to decoder audbile info ptr
audible_para_t *g_send_audible_p = (audible_para_t *) 0x9fc23000;
