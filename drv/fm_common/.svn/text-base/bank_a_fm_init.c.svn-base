...
int fmdrv_init(void* null1, void* null2, FM_init_parm_t *p_arg)
{
    ...
    fmdrv_print("fq",fm_init_parm.freq_mode,2);
    fmdrv_print("mod-",fm_init_parm.freq_mode,2);
    if(fm_init_parm.freq_mode == 1)
    {
        ...
        act_writel((act_readl(PADDRV0) & (~PADDRV0_GPIOA7_MASK))
                | ((uint32)fm_init_parm.gpio_level << PADDRV0_GPIOA7_SHIFT), PADDRV0);
