...
#ifdef SUPPORT_UI_DEBUG
#define ui_print(str, data, mode)   libc_print(str,data,mode) 
#else
#define ui_print(str, data, mode) 
#endif
...
#if (USE_NEW_FONTLIB)
/* 获取字库文件信息 */
Font_FileInfo_t* Font_GetFileInfo(sd_file_t* fontFile)__FAR__;
#endif
