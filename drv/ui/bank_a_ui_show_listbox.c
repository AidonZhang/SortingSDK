...
ui_result_e show_listbox(style_infor_t *listbox_style, listbox_private_t *listbox_data, list_draw_mode_e mode)
{
    ...
    {
        romf_show_pic(listbox.back_id, listbox.back_x, listbox.back_y);
    }
...
void show_list_slider(uint32 addr, listbox_private_t *listbox_data, list_draw_mode_e mode, res_open_infor_t *style_ptr)
{
    ...
    {
        romf_show_pic(list_slider.slider_back_id, list_slider.slider_back_x, list_slider.slider_back_y);
        prev_pixel = 0;
    }
    else
    {
        romf_show_pic(list_slider.slider_clear_id, list_slider.slider_point_x, list_slider.slider_point_y + prev_pixel);
    }
    ...
    romf_show_pic(list_slider.slider_point_id, list_slider.slider_point_x, list_slider.slider_point_y + cur_pixel);
