...
typedef enum
{
    ...
    /*! 设置AB复读上一步: A点<-- B点 */
    MSG_MENGINE_SET_AB_PREV_SYNC,   // 0x0310
    /*! 播放音乐 */
    ...
    /*! 获取当前时间的书签信息 */
    MSG_MENGINE_MAKE_BOOKMARK_SYNC,   // 0x320
    /*! 设置上次播放文件 */
    ...
    /*! 设置音量 */
    MSG_MENGINE_SET_VOLUME_SYNC,                      //    0x0330
    /*! 设置audible章节模式 */
    MSG_MENGINE_SET_SECTION_MODE_SYNC,
    /*! 播放APE CUE歌曲 */
    MSG_MENGINE_PLAY_CUE_SYNC,
    /*! 播放bookmark歌曲 */
    ...
    /* 设置频点播放( 同步)  */
    MSG_FMENGINE_SETFREQ_SYNC,   //0x0406    
    /* 设置静音或取消静音*/
    ...
    /* 启动软件搜台*/
    MSG_FMENGINE_SET_SOFTSEEK,   //0x040a
    /* 启动硬件搜台*/
    ...
    MSG_FMENGINE_GET_STATUS, //0x040f
    ...
    /* 获取当前模组状态*/
    MSG_FMENGINE_GET_MODUAL_STATUS,//0x0417
    /* 重建FM模组全局数组内容*/
