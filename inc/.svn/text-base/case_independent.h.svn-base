...
#define SUPPORT_DETECT_ENERGY   0 //是否支持能量检测
...
#define SUPPORT_CARD_DETECT     DETECT_BY_CMD //是否支持SD卡拔插检测
//#define SUPPORT_CARD_DETECT     DETECT_BY_GPIO//是否支持SD卡拔插检测
...
#define DAC_INNER   0//内部DAC
#define DAC_EXTERNAL 1//外部DAC
