...
/* 列表项（包括列表标题项）最长字符串缓冲区大小，50字节 
 这里不能再是52了，因为现在列表项已经是7项了，列表项是6项时，对应最大52*/

#define LIST_ITEM_BUFFER_LEN    50 //52
...
typedef enum
{
    ...
    /*! 含有按键选择的对话框,超时退出 */
    DIALOG_BUTTON_INCLUDE_WAIT  = 0x01,
...
extern app_result_e gui_text_read(const char* file_name) __FAR__;
...
extern void com_get_default_dae( dae_config_t * p_dae_cfg) __FAR__;
