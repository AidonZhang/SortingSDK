...
#if ((CASE_BOARD_TYPE == CASE_BOARD_DVB) || (CASE_BOARD_TYPE == CASE_BOARD_ATS2823) || (CASE_BOARD_TYPE == CASE_BOARD_DVB_ATS2823))

/* 模拟TWI 总线GPIO 配置宏*/
#define  TWI_SCL_BIT       11// 0//31
#define  TWI_SDA_BIT       19//15
...
/* 模拟TWI 总线GPIO 配置宏*/
#define  TWI_SCL_BIT        11//15
#define  TWI_SDA_BIT        19//31
#define  GPIO_SCL_BIT    (0x00000001<<TWI_SCL_BIT)
#define  GPIO_SDA_BIT    (0x00000001<<TWI_SDA_BIT)
