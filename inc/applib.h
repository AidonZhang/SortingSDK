...
//extern uint32 g_sys_shutdown_time;
extern uint8  g_sys_time_second;
//extern time_t g_next_second;
...
///获取按键音模式，1表示与音频同时输出，0表示禁止
static inline uint8 get_keytone_mode(void)
{
    return g_app_info_state.keytone_mode;
}
...
{
    return g_app_info_state.antenna_state; //tmp del 2015-12-25
}
