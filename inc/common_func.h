...
/*! “部分...”字符串最大长度，暂为 200 像素点 */
#define ELLIPSIS_MAX_LEN    180
...
extern void com_reset_dae_config(comval_t *setting_comval , dae_config_t * p_dae_cfg) __FAR__; //该接口仅仅在CONFIG开机时调用一次
extern void com_init_dae_config(dae_config_t * p_dae_param) __FAR__; //该接口仅仅在CONFIG开机时调用一次
...
extern void com_set_phy_volume(uint8 volume_val)__FAR__;
