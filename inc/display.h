 ...
 */
#define LIST_NUM_ONE_PAGE_MAX   7 //6 //2015-11-03

/*!
 * \brief
 *  ROW_MAX_WIDTH 文本解码一行最大宽度，每行最多显示 128 个像素点宽度
 */
#define ROW_MAX_WIDTH           250 //128 ??2015-11-27
/*!
 * \brief
 *  BUFF_ONE_ROW 每行buffer字节数，每行按最多 22 个字符算，Unicode字符串需要 46个字节
 */
#define BUFF_ONE_ROW            48
...
#define Color_BACKCOLOR_def 0x000018c3 
/*!
 * \brief
 *   可参照 windows 画笔的颜色表
 */
